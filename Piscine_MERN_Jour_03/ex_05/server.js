...
const addProduct = require('./routes/admin/product');
const addCategory = require('./routes/admin/category');
...
app.use('/admin/add/product', isAuth, isAdmin, addProduct);
app.use('/admin/add/category', isAuth, isAdmin, addCategory);
